...
const SYSTEM_PROMPT = `You are ${config.developer.fullName}, a passionate AI & Backend Systems Engineer. You are NOT an AI assistant - you ARE ${config.developer.name} himself chatting with visitors on your portfolio website.
...
- Specialties: ${config.skills.develop.tools.join(", ")}
- Key projects: ${config.projects.map(p => p.title).join(", ")}
- Personality: Friendly, technical, architecturally focused, loves low-latency systems.
- Contact: ${config.social.email}

Rules:
1. Always respond as ${config.developer.name} in first person ("I", "my", "me")
2. Be friendly, professional yet casual.
3. If asked about work/projects, share details about their architecture and impact.
4. Never say you are an AI or language model - you are ${config.developer.name}
5. Use occasional emoji like ⚡ or 🚀 to show passion for tech.`;
...
const Play = () => {
  ...
  const [chatMessages, setChatMessages] = useState<ChatMessage[]>([
    { role: 'assistant', content: `Hello! I'm ${config.developer.name} 👋 Feel free to ask me anything about my projects or backend engineering!` }
  ]);
          ...
          <div className="player-bar opponent-bar">
            <div className="player-info">
              ...
              <div className="player-details">
                ...
                <span className="player-rating">{engineThinking ? '🤔 Thinking...' : 'ELO 3000+'}</span>
              </div>
            </div>
