...
// Sandipan's exact tech stack from resume (pyramid: 7 -> 5 -> 4 -> 2)
const techStack: TechItem[][] = [
  // Row 1 - 7 items (Languages & Databases)
  [
    ...
    { name: "Neo4j", icon: "https://cdn.jsdelivr.net/gh/devicons/devicon/icons/neo4j/neo4j-original.svg", url: "https://neo4j.com" },
  ...
  // Row 2 - 5 items (Frameworks & Libraries)
  [
    ...
    { name: "WebSockets", icon: "https://cdn.jsdelivr.net/gh/devicons/devicon/icons/javascript/javascript-original.svg", url: "https://developer.mozilla.org/en-US/docs/Web/API/WebSockets_API" },
    { name: "Celery", icon: "https://cdn.jsdelivr.net/gh/devicons/devicon/icons/python/python-original.svg", url: "https://docs.celeryq.dev" },
    { name: "Streamlit", icon: "https://cdn.jsdelivr.net/gh/devicons/devicon/icons/python/python-original.svg", url: "https://streamlit.io" },
  ...
  [
    ...
    { name: "EC2", icon: "https://cdn.jsdelivr.net/gh/devicons/devicon/icons/amazonwebservices/amazonwebservices-original-wordmark.svg", url: "https://aws.amazon.com/ec2/" },
    { name: "Git", icon: "https://cdn.jsdelivr.net/gh/devicons/devicon/icons/git/git-original.svg", url: "https://git-scm.com" },
  ],
  // Row 4 - 2 items (AI & Semantic Search)
  [
    ...
    { name: "FAISS", icon: "https://cdn.jsdelivr.net/gh/devicons/devicon/icons/python/python-original.svg", url: "https://faiss.ai" },
  ],
];
